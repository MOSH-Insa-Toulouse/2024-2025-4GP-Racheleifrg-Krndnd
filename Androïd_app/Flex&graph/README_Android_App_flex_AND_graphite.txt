...
The user can start and stop data acquisition at any time. To differentiate between the two types of sensor data, the app uses least significant bit as an identifier. However, this method reduces the precision of the resistance values.
